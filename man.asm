...
.code ;segmento de código
	...
	ImprLst proc
		...
		xor al,al
		mov tpila,LENGTHOF lista_num
		ciclo:;Ciclo que permite iterar los elementos de la lista de numeros de 16 bits
			cmp cx, 0008h;Comparamos si ha alcanzado el maximo de elementos.
			...
			Salto ; Se imprime la variable que representa un salto de linea.
